...
class TuyaClient(private val context: Context? = null) {
    ...
    suspend fun sendCommand(
        ...
        try {
            ...
            log("[INFO] LAN IP (dispositivo Tuya): $lanIp")
            log("[INFO] ⚠️ IMPORTANTE: Este deve ser o IP do dispositivo Tuya na rede local")
            log("[INFO] ⚠️ NÃO use o IP do Android! Use o IP do dispositivo Tuya (ex: 192.168.0.193)")
